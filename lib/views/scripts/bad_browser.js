(function() {
	...
	function show_banner() {
		...
		var message = 'You are using an out-of-date version of <%= browser_name %> (<%= version ? version.string : "?" %>). It is encouraged that you update your browser. <a href="<%= read_param(:link) || default_info_link %>?for=<%= browser %>&version=<%= version ? version.string : 0 %>" style="color:#8B0000">Click here</a> for more details.';
